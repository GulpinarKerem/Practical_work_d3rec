...
def main(args, dataset_dir_path, best_model_path):
    ...
    user_gender_map = dataset.user_gender
...
def get_args_parser():
    ...
    parser.add_argument('--sep', default='::', type=str, help="Separator")
    parser.add_argument('--drop_rating', default=0, type=int, help="Drop low ratings")
