...
def main(args, dataset_dir_path, best_model_path):
    ...
    # Training sırasında gender_map lazım (evaluate fonksiyonu istiyor)
    # Boş dict veriyoruz — training evaluate'i gender ayrımı yapmıyor zaten
    empty_gender_map = {}
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        if epoch % args.eval_freq == 0:
            valid_results = evaluate(
                ...
                n_cate=dataset.num_cate,
                temperature=1.0,
                user_gender_map=empty_gender_map,
                is_best=False,
            )
...
def get_args_parser():
    ...
    parser.add_argument('--patient', default=1000, type=int)
